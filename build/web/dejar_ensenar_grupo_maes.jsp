...
<html>
    <head>
        ...
        <title>Dejar de enseñar grupo - maestro</title>
    ...
    <body>
        <form action="eliminar_mg.jsp" method="post">
            <%
                Connection con=null;
                ...
                try {
                    ...
                    out.println("Grupos a los que les enseñas <select name='Grupos' id='Grupos'>");
            ...
            <br>
            <br>
            <input type="submit" value="Dejar de Enseñar Grupos">
        </form>
    </body>
</html>