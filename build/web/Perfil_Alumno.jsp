...
<html>
   ...
   <script>
    ...
    <body onload="cambio=setInterval('cambi()',3000)">
        ...
        <div class='principal' style='width:100%;height:100%;background-color: rgba(0,0,0,0.2);'><br><h1>Perfil Alumno</h1><br>
        <%
            Connection con=null;
            ...
            try{
                ...
                if(resul.next()){
                    ...
                    out.println("<h3 class='overlay'> Alumno: "+sesion.getAttribute("Nombre")+" &nbsp;&nbsp;</h3>");
                    out.println("</div>");
                    out.println("<br>");
                    out.println("<a href='vista_datos_alum.jsp'><button class='button'>Consultar datos</button></a>");
                    out.println("<br>");
                    out.println("<br>");
                    out.println("<a href='modificar_alumno.jsp'><button class='button'>Modificar datos</button></a>");
                    out.println("<br>");
                    out.println("<br>");
                }
            }
