        ...
        <%
            ...
            try{
                ...
                if(resul.next()){
                    ...
                    out.println("</div><div><form action='actualizar_maes.jsp' method='post' enctype='multipart/form-data' id='datosmaestro'>");
                    out.println("<fieldset><legend>Datos Personales</legend>");
                    out.println("Apellido Paterno: <input type='text'  name='Apellido_Paterno' id='Apellido_Paterno' placeholder='Apellido Paterno' onkeypress='Validar()' onkeyup='Mayus2()' maxlength='30' value='"+resul.getString("ApellidoP")+"'>");
                    out.println("<br><br>");
                    out.println("Apellido Materno: <input type='text' name='Apellido_Materno' id='Apellido_Materno' placeholder='Apellido Materno' onkeypress='Validar()' onkeyup='Mayus3()' maxlength='30' value='"+resul.getString("ApellidoM")+"'>");
                    out.println("<br><br>");
                    out.println("Nombre(s): <input type='text' name='Nombre' id='Nombre' placeholder='Nombre(s)' onkeypress='Validar()' onkeyup='Mayus4()' maxlength='50' value='"+resul.getString("Nombre_Maes")+"'>");
                    out.println("<br><br>");
                    ...
                    out.println("<br><br>");
                    out.println("<input accept='image/*' type='file' name='imagen' id='imagen' onchange='prevista(imagen)' >");
                    out.println("<br><br>");
                    ...
                    out.println("Numero Exterior: <input type='text' maxlength='5' name='NExterior' id='NExterior' placeholder='Numero Exterior' onkeypress='Validar2()' value='"+resul.getInt("NE_Maes")+"'>");
                    out.println("<br><br>");
                    out.println("Calle: <input type='text' name='Calle' maxlength='60' id='Calle' placeholder='Calle' onkeypress='Validar4()' value='"+resul.getString("Calle_Maes")+"'>");
                    out.println("<br><br>");
                    out.println("Municipio: <input type='text' name='Municipio' maxlength='30' id='Municipio' placeholder='Municipio' onkeypress='Validar()' value='"+resul.getString("Muni_Maes")+"'>");
                    out.println("<br><br>");
                    out.println("<input id='estado1' value='"+resul.getInt("Id_Estado_Maes")+"' disabled type='text' name='estado1' style='visibility: hidden; top: 0px; left: 0px; position: absolute;'>");
                    ...
                    out.println("<input type='text' name='Contacto' id='Contacto' placeholder='Contacto' disabled maxlength='30' value='"+resul.getString("Contacto")+"'>");
                    out.println("</fieldset></fieldset>");
                    out.println("<br><br><br>");
                    out.println("<fieldset>");
                    out.println("<legend>Datos de Director</legend>");
                    out.println("RFC: <input type='text' name='RFC' id='RFC' placeholder='RFC' onkeypress='Validar3();' onkeyup='Mayus(this);' maxlength='13' value='"+resul.getString("RFC")+"'>");
                    out.println("</fieldset>");
                    out.println("<br><br><br>");
                    out.println("<fieldset>");
                    out.println("<legend>Datos de usuario</legend>");
                    out.println("<br>");
                    out.println("Usuario: <input type='text' maxlength='30' name='usuario' id='usuario' placeholder='Usuario' onkeypress='Validar4();' value='"+resul.getString("Usuario")+"'>");
                    out.println("<br><br>");
                    out.println("Contraseña: <input type='password' maxlength='20' name='contrasena' id='contrasena' placeholder='Contraseña' onkeypress='Validar4()' value='"+resul.getString("Contra")+"'>");
                    out.println("<br><br>");
                    out.println("Confirmar Contraseña: <input type='password' maxlength='20' name='conf_contrasena' id='conf_contrasena' placeholder='Confirmar Contraseña' onkeypress='Validar4()' value='"+resul.getString("Contra")+"'>");
                    ...
                    out.println("</select>");
                    out.println("</fieldset><br><input type='button' value='Enviar Datos' onclick='ValidarDatos();'></form></div></div>");
                }
            }
