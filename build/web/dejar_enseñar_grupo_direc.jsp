...
<html>
    <head>
        ...
        <title>Dejar de enseñar grupo - director</title>
    ...
    <body>
         ...
         <div class="principal" style="height: 100%; width: 100%; background-color: rgba(0,0,0,0.2);">
            <br><br><br><br><br><br>
            <h1 style="font-weight: 900;">Dejar de Enseñar Grupos - Director</h1>
            <br><br>
        <form action="eliminar_dg.jsp" method="post">
            <%
                Connection con=null;
                ...
                try {
                    ...
                    out.println("<h3>Grupos a los que le enseña:</h3><br> <select name='Grupos' id='Grupos'>");
