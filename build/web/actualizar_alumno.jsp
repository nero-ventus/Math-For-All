    ...
    <body>
        <%
            ...
            try{
                ...
                sta=con.prepareCall("call sp_Alum(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?);");
                sta.setInt(1, (int)(sesion.getAttribute("Id")));
                sta.setBytes(2, fileContent);
                sta.setString(3, archivo.getName());
                sta.setString(4, Usuario_Alum);
                sta.setString(5, Contraseña_Alum);
                sta.setInt(6, NExterior_Alum);
                sta.setString(7, Calle_Alum);
                sta.setString(8, Municipio_Alum);
                sta.setInt(9, Id_Estado_Alum);
                sta.setString(10, ApellidoP_Alum);
                sta.setString(11, ApellidoM_Alum);
                sta.setString(12, Nombre_Alum);
                sta.setString(13, FechaN_Alum);
                sta.setInt(14, Id_Sexo_Alum);
                sta.setString(15, Curp_Alum);
                sta.setInt(16, Id_Grupo);
                sta.setInt(17, Id_Escuela);
                sta.setInt(18, Id_Tipo_Contacto);
                sta.setString(19, Descripcionn);
                sta.executeUpdate();
                con.close();
                archivo.delete();
                out.println("<script> alert('Registro hecho'); </script>");
                
                out.println("<script type='text/javascript'> window.location='http://localhost:8084/Proyecto_Fase_Final/Perfil_Alumno.jsp'; </script>");
            }
