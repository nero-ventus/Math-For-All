...
<nav class="w3-sidebar w3-red w3-collapse w3-top w3-large w3-padding" style="z-index:3;width:300px;font-weight:bold;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
      <a href="Aprender.jsp" onclick="w3_close()" class="w3-bar-item w3-button w3-hover-white">Aprender</a>
      <a href="lecciones.html" onclick="w3_close()" class="w3-bar-item w3-button w3-hover-white">Lecciones</a>
      <a href="Perfil_Alumno.jsp" onclick="w3_close()" class="w3-bar-item w3-button w3-hover-white">Perfil</a>
      ...
      <%
            ...
            try{
                ...
                if(resul.next()){
                    ...
                    out.println("<a class='w3-bar-item w3-button w3-hover-white'> Alumno: "+sesion.getAttribute("Nombre")+"</a>");
                    ...
                    if(resul.getInt("Cantidad")<23 && resul.getInt("Cantidad")>-1){
                        out.println("<a class='w3-bar-item w3-button w3-hover-white'>Alumno Nivel 1</a>");
                        ...
                        if(resul.getInt("Cantidad")<45 && resul.getInt("Cantidad")>22){
                            out.println("<a class='w3-bar-item w3-button w3-hover-white'>Alumno Nivel 2</a>");
                            ...
                            if(resul.getInt("Cantidad")<67 && resul.getInt("Cantidad")>44){
                                out.println("<a class='w3-bar-item w3-button w3-hover-white'>Alumno Nivel 3</a>");
                                ...
                                if(resul.getInt("Cantidad")<89 && resul.getInt("Cantidad")>66){
                                    out.println("<a class='w3-bar-item w3-button w3-hover-white'>Alumno Nivel 4</a>");
                                    ...
                                    if(resul.getInt("Cantidad")<111 && resul.getInt("Cantidad")>88){
                                        out.println("<a class='w3-bar-item w3-button w3-hover-white'>Alumno Nivel 5</a>");
