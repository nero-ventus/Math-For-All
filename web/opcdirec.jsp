...
<nav class="w3-sidebar w3-red w3-collapse w3-top w3-large w3-padding" style="z-index:3;width:300px;font-weight:bold;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
      <a href="Gestion de Grupos Director.html" onclick="w3_close()" class="w3-bar-item w3-button w3-hover-white">Gestion de Grupos</a>
      <a href="opciones_imprimir_direc.html" onclick="w3_close()" class="w3-bar-item w3-button w3-hover-white">Impresion de datos</a>
      <a href="Perfil_Director.jsp" onclick="w3_close()" class="w3-bar-item w3-button w3-hover-white">Perfil</a>
      <a href="Registro_Preguntas.html" onclick="w3_close()" class="w3-bar-item w3-button w3-hover-white">Registro de Preguntas</a>
      ...
      <%
            ...
            try{
                ...
                if(resul.next()){
                    ...
                    out.println("<a class='w3-bar-item w3-button w3-hover-white'> Director: "+sesion.getAttribute("Nombre")+"</a>");
