...
<html>
    ...
    <body onload="cambio=setInterval('regreso()',3000)">
        <%
            ...
            try{
                sta=con.prepareStatement("select Director.Id_Director from Director inner join Datos_Usuario,Datos_Cuenta where Datos_Usuario.Id_Datos_Usuario=Director.Id_Datos_Usuario and Datos_Cuenta.Id_Datos_Cuenta=Datos_Usuario.Id_Datos_Cuenta and Datos_Cuenta.Id_Datos_Cuenta=?;");
                sta.setInt(1, (int)(sesion.getAttribute("Id")));
                resul=sta.executeQuery();
                if(resul.next()){
                    String ruta=config.getServletContext().getRealPath("/");
                    sta=con.prepareStatement("select Grupo.Nombre as Grupo,Puntuacion.Cantidad,Escuela.Nombre as Nombre_Escuela,Datos_Usuario.Apellido_Paterno,Datos_Usuario.Apellido_Materno,Datos_Usuario.Nombre as Nombre_Alumno from Puntuacion inner join Escuela,Datos_Usuario,Alumno,Relacion_Director_Grupo,Grupo where Grupo.Id_Grupo=Alumno.Id_Grupo and Alumno.Id_Puntuacion=Puntuacion.Id_Puntuacion and Alumno.Id_Datos_Usuario=Datos_Usuario.Id_Datos_Usuario and Alumno.Id_Escuela=Escuela.Id_Escuela and Alumno.Id_Grupo=Relacion_Director_Grupo.Id_Grupo and Relacion_Director_Grupo.Id_Director=? order by Puntuacion.Cantidad desc;");
                    sta.setInt(1, resul.getInt("Id_Director"));
                    ...
                    documento.open();
                    documento.add(new Paragraph("Datos de tus Alumnos"));
