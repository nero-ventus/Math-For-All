        ...
        <%
            ...
            try{
                ...
                if(resul.next()){
                    ...
                    out.println("Nombre(s): <input type='text' disabled name='Nombre' id='Nombre' onkeypress='Validar()' placeholder='Nombre' onkeyup='Mayus4()' maxlength='50' value='"+resul.getString("Nombre_Alum")+"'>");
                    out.println("Apellido Paterno: <input type='text'disabled name='ApPaterno' id='ApPaterno' onkeypress='Validar()' placeholder='Apellido Paterno' onkeyup='Mayus2()' maxlength='30' value='"+resul.getString("ApellidoP")+"'>");
                    out.println("Apellido Materno: <input type='text'disabled name='ApMaterno' id='ApMaterno' onkeypress='Validar()' placeholder='Apellido Materno' onkeyup='Mayus3()' maxlength='30' value='"+resul.getString("ApellidoM")+"'>");
                    out.println("Fecha de Nacimiento: <input type='date' disabled name='FechaNacimiento' id='FechaNacimiento' max='2004-12-31' min='1950-12-31' value='"+resul.getDate("Fecha")+"'>");
                    out.println("Curp: <input type='text' disabled name='Curp1' id='Curp1' onkeypress='Validar3()' maxlength='18' placeholder='CURP' onkeyup='Mayus();' value='"+resul.getString("Curp")+"'>");
                    out.println("<input id='sexo1' disabled value='"+resul.getInt("Id_Sexo_Alum")+"' type='text' name='sexo1' style='visibility: hidden; top: 0px; left: 0px; position: absolute;'>");
                    out.println("<select id='Sexo' disabled name='Sexo' onclick='Desactivar()'>");
                    ...
                    out.println("<select id='TipoContacto' disabled name='TipoContacto' onchange='  SpawnContacto();' onclick='Desactivar()' >");
                    ...
                    out.println("</select>");
                    out.println("<input type='text' id='Contacto' disabled name='Contacto' disabled onkeypress='Validar4()' placeholder='Contacto' maxlength='30' value='"+resul.getString("Contacto")+"'>");
                    out.println("<fieldset>");
                    out.println("<legend>Direccion</legend>");
                    out.println("Numero Exterior: <input type='text' disabled name='AlumNumExt' id='AlumNumExt' onkeypress='Validar2()' placeholder='Numero Exterior' maxlength='5' value='"+resul.getInt("NE_Alum")+"'>");
                    out.println("Calle: <input type='text' name='AlumCalle' disabled id='AlumCalle' onkeyup='Mayus5()' onkeypress='Validar4()' placeholder='Calle' maxlength='60' value='"+resul.getString("Calle_Alum")+"'>");
                    out.println("Municipio: <input type='text' name='AlumMunicipio' disabled id='AlumMunicipio' onkeyup='Mayus6()' onkeypress='Validar()' placeholder='Municipio' maxlength='30' value='"+resul.getString("Muni_Alum")+"'>");
                    out.println("<input id='estado1' value='"+resul.getInt("Id_Escuela_Alum")+"' disabled type='text' name='estado1' style='visibility: hidden; top: 0px; left: 0px; position: absolute;'>");
                    out.println("Estado: <select disabled id='AlumEstado' name='AlumEstado' onclick='Desactivar();'>");
                    ...
                    out.println("Usuario: <input type='text' disabled id='Usuario' name='Usuario' onkeypress='Validar4()' placeholder='Usuario' maxlength='30' value='"+resul.getString("Usuario")+"'>");
                    out.println("Contraseña <input type='password' disabled id='Contrasenia' name='Contrasenia' onkeypress='Validar4()' placeholder='Contraseña' maxlength='20' value='"+resul.getString("Contra")+"'>");
                    out.println("Confirmar Contraseña <input type='password' disabled id='ConfContrasenia' name='ConfContrasenia' onkeypress='Validar4()' placeholder='Confirmar Contraseña' maxlength='20' value='"+resul.getString("Contra")+"'>");
                    out.println("Foto de Perfil: <input accept='image/*' type='file' disabled name='imagen' id='imagen' onchange='prevista(imagen)'>");
                    out.println("<br>");
                    ...
                    out.println("<input id='escuela1' disabled value='"+resul.getInt("Id_Escuela_Alum")+"' type='text' name='escuela1' style='visibility: hidden; top: 0px; left: 0px; position: absolute;'>");
                    out.println("<select id='Escuela' disabled name='Escuela' onclick='Desactivar();' onchange='borrar(Grupo), Agregar();'>");
                    ...
                    out.println("</select>");
                    out.println("<input id='grupo1' disabled value='"+resul.getInt("Id_Grupo_Alum")+"' type='text' name='grupo1' style='visibility: hidden; top: 0px; left: 0px; position: absolute;'>");
                    out.println("<select id='Grupo' disabled name='Grupo' disabled onclick='Desactivar()' onchange='ActiTurno()' disabled><option  value='0' > Grupo </option></select>");
                    out.println("<input type='text' id='Turno' disabled name='Turno' style='visibility: hidden;'>");
                    out.println("</fieldset>");
                    out.println("<br>");
                    out.println("</div></div>");
                }
