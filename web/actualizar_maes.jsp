    ...
    <body>
        <%
            ...
            try{
                ...
                sta=con.prepareCall("call sp_Maes(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?);");
                sta.setInt(1, (int)(sesion.getAttribute("Id")));
                sta.setBytes(2, fileContent);
                sta.setString(3, archivo.getName());
                sta.setString(4, Usuario_Maes);
                sta.setString(5, Contraseña_Maes);
                sta.setInt(6, NExterior_Maes);
                sta.setString(7, Calle_Maes);
                sta.setString(8, Municipio_Maes);
                sta.setInt(9, Id_Estado_Maes);
                sta.setString(10, ApellidoP_Maes);
                sta.setString(11, ApellidoM_Maes);
                sta.setString(12, Nombre_Maes);
                sta.setString(13, FechaN_Maes);
                sta.setInt(14, Id_Sexo_Maes);
                sta.setString(15, RFC_Maestro);
                ...
                con.close();
                archivo.delete();
                sesion.setAttribute("Nombre", Nombre_Maes);
                out.println("<script> alert('Registro hecho'); </script>");
                out.println("<script type='text/javascript'> window.location='http://localhost:8084/Proyecto_Fase_Final/Perfil_Maestro.jsp'; </script>");
            }
