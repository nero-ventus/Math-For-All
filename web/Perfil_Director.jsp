...
<html>
   ...
   <script>
    ...
    <body onload="cambio=setInterval('cambi()',3000)">
        ...
        <div class='principal' style='width:100%;height:100%;background-color: rgba(0,0,0,0.2);'><br><h1>Perfil Director</h1><br>
        <%
            Connection con=null;
            ...
            try{
                ...
                if(resul.next()){
                    ...
                    out.println("<h3 class='overlay'> Director: "+sesion.getAttribute("Nombre")+" &nbsp;&nbsp;</h3>");
                    out.println("</div>");
                    out.println("<br>");
                    out.println("<td><a href='vista_datos_direc.jsp' target='dos'><button class='button'>Consultar datos</button></a></td>");
                    out.println("<br>");
                    out.println("<br>");
                    out.println("<td><a href='Cambios.html' target='dos'><button class='button'>Modificar datos</button></a></td>");
                    out.println("<br>");
                    out.println("<br>");
                }
            }
